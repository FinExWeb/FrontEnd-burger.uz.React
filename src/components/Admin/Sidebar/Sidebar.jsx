    ...
    return (
        <div className='app-body'>
            ...
            <div className="routes ">
                <Link to='/myadmin/dashboard' className={hover === 'hover' ? 'hover' : ''} onClick={() => setHover('hover')}>
                    <img src={dashboard} alt="dashboard" />
                    <span>DASHBOARD</span>
                </Link>

                <Link to='/myadmin/newuser' className={hover === 'admin' ? 'hover' : ''} onClick={() => setHover('admin')}>
                    <img src={newUser} alt="newUser" />
                    <span>YANGI ADMINLAR QO’SHISH</span>
                </Link>

                <Link to='/new-food' className={hover === 'food' ? 'hover' : ''} onClick={() => setHover('food')}>
                ...
                <Link to='/message-view' className={hover === 'chat' ? 'hover' : ''} onClick={() => setHover('chat')}>
...
// Qareng sayt refresh bolganidan keyin useState to'g'ri ishlidi, keyinchalik chala ishlaydi!